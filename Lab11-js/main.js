...
console.log("incrementerPur(10):", incrementerPur(10));
...
//Exercice 7.1 — Comparer deux styles
...
//Exercice 8.1 — Sécurité face à null/undefined
...
//Exercice 8.2 — Idempotence d’une fonction pure
const normalizeNom = s => s.trim().replace(/\s+/g, ' ').toLowerCase();
console.log(normalizeNom("  Jean  Dupont "), normalizeNom("  Jean  Dupont ")); 